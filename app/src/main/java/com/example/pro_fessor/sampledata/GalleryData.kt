...
object GalleryData {
    private val galleryList: MutableList<GalleryDto> =
        mutableListOf(
            GalleryDto("2024-12-29",1, "연구실 탐험1", "오늘은 연구실1 탐험을 했어요", "", R.drawable.img_3),
            GalleryDto("2024-12-29",2, "연구실 탐험1", "오늘은 연구실1 탐험을 했어요", "", R.drawable.img_3),
            GalleryDto("2024-12-29",2, "연구실 탐험2", "오늘은 연구실2 탐험을 했어요", "@drawable/img", R.drawable.img_3),
            GalleryDto("2024-12-29",3, "연구실 탐험3", "오늘은 연구실3 탐험을 했어요", "@drawable/img", R.drawable.img_3),
            GalleryDto("2024-12-29",4, "연구실 탐험4", "오늘은 연구실4 탐험을 했어요", "@drawable/img", R.drawable.img_3),
            GalleryDto("2024-12-29",5, "연구실 탐험5", "오늘은 연구실5 탐험을 했어요", "@drawable/img", R.drawable.img_3),
