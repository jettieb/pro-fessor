...
object MissionData {
    fun getMissionDataList(): List<MissionDto> {
        return listOf(
            ...
            MissionDto("매일 영어 논문 읽기", LocalDate.of(2024, 1, 3), LocalDate.of(2024, 1, 17), true, 3, 0),
            MissionDto("코딩 연습 하루 2시간", LocalDate.of(2024, 1, 4), LocalDate.of(2024, 1, 14), true, 4, 0),
            MissionDto("실험 데이터 정리", LocalDate.of(2024, 1, 5), LocalDate.of(2024, 1, 8), true, 5, 0),
            ...
            MissionDto("주간 학습 보고서 작성", LocalDate.of(2024, 1, 8), LocalDate.of(2024, 1, 12), true, 8, 0),
            MissionDto("코드 리뷰 참여", LocalDate.of(2024, 1, 9), LocalDate.of(2024, 1, 16), false, 9, 0),
            MissionDto("주말 프로젝트 진행", LocalDate.of(2024, 1, 10), LocalDate.of(2024, 1, 20), true, 10, 0),
            ...
            MissionDto("스터디 그룹 참여", LocalDate.of(2024, 1, 14), LocalDate.of(2024, 1, 22), true, 4, 0),
            MissionDto("소논문 리뷰 작성", LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 23), false, 5, 0),
            MissionDto("도서 요약 발표 준비", LocalDate.of(2024, 1, 16), LocalDate.of(2024, 1, 24), true, 6, 0),
            MissionDto("학기말 프로젝트 계획 세우기", LocalDate.of(2024, 1, 17), LocalDate.of(2024, 1, 25), true, 7, 0),
            ...
            MissionDto("매일 연구 로그 작성", LocalDate.of(2024, 1, 20), LocalDate.of(2024, 1, 30), true, 10, 0)
        )
    }
}
